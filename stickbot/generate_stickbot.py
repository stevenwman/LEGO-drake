...
def generate_stickbot(params=params_mugatu):
    ...
    params['mot_x'] = 0.02 * viz_scaling
    params['mot_y'] = 0.01 * viz_scaling
    params['mot_z'] = 0.02 * viz_scaling
...
if __name__ == "__main__":
    ...
    print("Stick bot URDF generated successfully.")